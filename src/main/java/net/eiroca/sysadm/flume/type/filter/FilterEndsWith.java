...
public class FilterEndsWith extends FilterBlackOrWhite {
  ...
  public boolean isInWhiteList(final String match) {
    return (filterWhiteList != null) ? match.endsWith(filterWhiteList) : false;
  }

  @Override
  public boolean isInBlackList(final String match) {
    return (filterBlackList != null) ? match.endsWith(filterBlackList) : false;
  }
