...
public class FilterStartsWith extends FilterBlackOrWhite {
  ...
  public boolean isInWhiteList(final String match) {
    return (filterWhiteList != null) ? match.startsWith(filterWhiteList) : false;
  }

  @Override
  public boolean isInBlackList(final String match) {
    return (filterBlackList != null) ? match.startsWith(filterBlackList) : false;
  }
